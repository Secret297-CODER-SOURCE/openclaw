...
export const en: TranslationMap = {
  ...
  chat: {
    ...
    composeAttachmentPlaceholder: "Add a message or paste more images...",
    connectPlaceholder: "Connect to the gateway to start chatting…",
    queuedLabel: "Queued ({count})",
    stopBtn: "Stop",
  ...
  cronView: {
    ...
    mainTimelineMsg: "Main timeline message",
    ...
    wakeModeField: "Wake mode",
    timeoutField: "Timeout (seconds)",
    deliveryField: "Result delivery",
    staggerField: "Stagger window",
    modelField: "Model",
    ...
    needJitter: "Need jitter? Use Advanced",
    cancelBtn: "Cancel",
    next13: "Next 13",
    sectionBasics: "Basics",
    sectionBasicsSub: "Name it, choose the assistant, and set enabled state.",
