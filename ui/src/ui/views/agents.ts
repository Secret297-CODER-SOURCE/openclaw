      ...
      <section class="agents-main">
        ${
          !selectedAgent
            ? html`
                <div class="card">
                  <div class="card-title">${t("agentsView.selectTitle")}</div>
                  <div class="card-sub">${t("agentsView.selectDesc")}</div>
                </div>
              `
            : html`
                ${renderAgentHeader(
...
function renderAgentTabs(active: AgentsPanel, onSelect: (panel: AgentsPanel) => void) {
  const tabs: Array<{ id: AgentsPanel; label: string }> = [
    { id: "overview", label: t("agentsView.tabOverview") },
    { id: "files", label: t("agentsView.tabFiles") },
    { id: "tools", label: t("agentsView.tabTools") },
    { id: "skills", label: t("agentsView.tabSkills") },
    { id: "channels", label: t("agentsView.tabChannels") },
    { id: "cron", label: t("agentsView.tabCron") },
  ];
  return html`
...
function renderAgentOverview(params: {
  ...
  return html`
    <section class="card">
      ...
      <div class="card-sub">${t("agentsView.overviewSubtitle")}</div>
      <div class="agents-overview-grid" style="margin-top: 16px;">
        <div class="agent-kv">
          <div class="label">${t("agentsView.workspaceLabel")}</div>
          <div class="mono">${workspace}</div>
        </div>
        <div class="agent-kv">
          <div class="label">${t("agentsView.primaryModelLabel")}</div>
          <div class="mono">${model}</div>
        </div>
        <div class="agent-kv">
          <div class="label">${t("agentsView.identityNameLabel")}</div>
        ...
        <div class="agent-kv">
          ...
          <div>${isDefault ? t("ui.yes").toLowerCase() : t("ui.no").toLowerCase()}</div>
        </div>
        <div class="agent-kv">
          <div class="label">${t("agentsView.identityEmojiLabel")}</div>
          <div>${identityEmoji}</div>
        </div>
        <div class="agent-kv">
          <div class="label">${t("agentsView.skillsFilterLabel")}</div>
          <div>${skillFilter ? `${skillCount} ${t("agentsView.selectedSuffix")}` : t("agentsView.allSkills")}</div>
        </div>
      </div>

      <div class="agent-model-select" style="margin-top: 20px;">
        <div class="label">${t("agentsView.modelSelectionLabel")}</div>
        <div class="row" style="gap: 12px; flex-wrap: wrap;">
          <label class="field" style="min-width: 260px; flex: 1;">
            <span>${t("agentsView.primaryModel")}${isDefault ? ` (${t("agentsView.defaultLabel").toLowerCase()})` : ""}</span>
            <select
            ...
            >
              ${
                isDefault
                  ...
                  : html`
                      <option value="">
                        ${defaultPrimary ? `${t("agentsView.inheritDefault")} (${defaultPrimary})` : t("agentsView.inheritDefault")}
                      </option>
                    `
              }
          ...
          <label class="field" style="min-width: 260px; flex: 1;">
            <span>${t("agentsView.fallbacksLabel")}</span>
            <input
              .value=${fallbackText}
              ?disabled=${!configForm || configLoading || configSaving}
