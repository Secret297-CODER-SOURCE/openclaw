...
// ─────────────────────────────────────────────────────────────────────────────
// Токены генерируются с ровно 6 hex-символами, но LLM может незначительно
// изменить суффикс. Диапазон {4,8} обеспечивает устойчивость при восстановлении.
const TOKEN_PATTERN = /\[[А-ЯЁA-Z0-9_]+_[0-9A-F]{4,8}\]/g;
